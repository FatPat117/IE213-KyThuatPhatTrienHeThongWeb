...
import { useReadAllCampaigns } from "@/lib";
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="rounded-xl bg-white border border-slate-200 p-4 shadow-sm">
              ...
              <p className="text-2xl font-bold text-green-600 mt-1">
                {isLoading ? "..." : campaigns.filter(c => !c.completed).length}
              </p>
            </div>
            <div className="rounded-xl bg-white border border-slate-200 p-4 shadow-sm">
        ...
        <section className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          {!isLoading && isError && (
            <div className="col-span-full rounded-2xl border border-red-200 bg-red-50 p-8 text-center">
              ...
              <p className="text-sm text-red-700 mb-4">{error || "Có lỗi xảy ra. Vui lòng kiểm tra kết nối ví/mạng."}</p>
              <button
                onClick={() => refetch()}
