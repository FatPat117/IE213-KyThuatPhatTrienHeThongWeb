                ...
                <main className="mx-auto w-full max-w-7xl px-6 py-12 md:px-10">
                    <div className="rounded-2xl border-2 border-slate-200 bg-slate-50 p-12 text-center shadow-inner">
                        ...
                        <p className="text-slate-600 mb-6">
                            Vui lòng kết nối ví để xem và quản lý các chiến dịch
                            của bạn.
                        </p>
                        <Link
                            href="/"
                ...
                {!isSepoliaNetwork && isConnected && (
                    <div className="mb-6 rounded-lg border border-red-300 bg-red-50 p-4">
                        <p className="text-sm font-semibold text-red-900">
                            ⚠️ Mạng lưới không khớp
                        </p>
                        <p className="text-xs text-red-800 mt-1">
                            Vui lòng chuyển sang mạng Sepolia để quản lý chiến
                            dịch của bạn.
                        </p>
                    </div>
                )}
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            ...
                            <p className="text-lg text-slate-600">
                                Quản lý và theo dõi tiến độ các chiến dịch bạn
                                đã khởi tạo
                            </p>
                        </div>
                ...
                <section className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    {!isLoading && normalizedCampaigns.length === 0 && (
                        <div className="col-span-full rounded-2xl border-2 border-dashed border-slate-300 bg-slate-50 p-12 text-center">
                            ...
                            <p className="text-slate-600 mb-6">
                                Bắt đầu hành trình gây quỹ của bạn ngay hôm nay!
                            </p>
                            <Link
                                href="/campaigns/create"
                    ...
                    {paginatedCampaigns.map((campaign) => {
                        ...
                        const mStatus =
                            milestoneStatusByCampaignId[campaign.id];

                        return (
                            <div
                                key={campaign.id}
                                className="flex flex-col h-full rounded-xl border border-slate-200 bg-white shadow-sm transition-all duration-200 hover:shadow-md group"
                            >
                                {/* Thumbnail Image */}
                                <div className="relative w-full h-48 bg-gradient-to-br from-indigo-400 to-blue-500 overflow-hidden rounded-t-xl">
                                ...
                                <div className="p-5 flex-1 flex flex-col">
                                    <div className="flex items-start justify-between mb-4">
                                        <div className="flex flex-col items-end gap-1">
                                            <span
                                                className={`rounded-full border px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider ${statusClasses}`}
                                            >
                                                {isPendingApproval
                                                    ? "Chờ duyệt"
                                                    : normalizedStatus ===
